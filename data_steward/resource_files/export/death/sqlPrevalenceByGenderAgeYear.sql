...
from 
	(select CAST(stratum_1 as int64) stratum_1, CAST(stratum_2 as int64) stratum_2, CAST(stratum_3 as int64) stratum_3, count_value from @results_database_schema.achilles_results where analysis_id = 504 GROUP BY analysis_id, stratum_1, stratum_2, stratum_3, count_value) num
	inner join
	(select CAST(stratum_1 as int64) stratum_1, CAST(stratum_2 as int64) stratum_2, CAST(stratum_3 as int64) stratum_3, count_value from @results_database_schema.achilles_results where analysis_id = 116 GROUP BY analysis_id, stratum_1, stratum_2, stratum_3, count_value) denom on num.stratum_1 = denom.stratum_1  --calendar year
