...
def run_retraction_cron():
    ...
    # If the env variable RETRACTION_DATASET_IDS does not exist, dataset_ids will be set to None
    # This allows retraction to be performed on all datasets existing in the project
    if dataset_ids is not None:
        dataset_ids = dataset_ids.split()
    logging.info('Dataset ids from env variable: %s' % dataset_ids)
    ...
    # If the env variable RETRACTION_SUBMISSION_FOLDER does not exist, folder will be set to None
    # This allows retraction to be performed on all folders submitted by the site that exist in the archive
    logging.info('Submission folder from env variable: %s of type %s' % (folder, type(folder)))
