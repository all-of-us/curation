...
def mapping(domain_table, input_dataset_id, mapping_dataset_id, project_id):
    """
...
def table_query(client, table_name, input_dataset_id, mapping_dataset_id,
...
def load(client, table_name, input_dataset_id, output_dataset_id, project_id,
    ...
    """
    LOGGER.info(
        f'Loading {table_name} from {input_dataset_id} into {output_dataset_id}.{table_name}'
    )
    ...
    q = table_query(client, table_name, input_dataset_id, mapping_dataset_id,
                    project_id, pipeline_dataset_id, rt_ids_view)
    query_result = bq_utils.query(q,
...
def main(input_dataset_id, output_dataset_id, project_id, pipeline_dataset_id,
         rt_ids_view, mapping_dataset_id):
    """
    ...
    for table in ETM_TABLES:
        ...
        mapping(table, input_dataset_id, mapping_dataset_id, project_id)
