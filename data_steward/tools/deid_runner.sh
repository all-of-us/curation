...
bq mk --dataset --description "${version} deidentified version of ${cdr_id}" --label "type:deid" --label "release_tag:${dataset_release_tag}" --label "de_identified:true" "${APP_ID}":"${registered_cdr_deid}"
...
bq mk --dataset --description "Intermediary dataset to apply cleaning rules on ${registered_cdr_deid}" --label "type:staging" --label "release_tag:${dataset_release_tag}" --label "de_identified:true" ${APP_ID}:${cdr_deid_base_staging}
...
bq update --description "${version} De-identified Base version of ${cdr_id}" --label "type:deid_base" --label "release_tag:${dataset_release_tag}" --label "de_identified:true" ${APP_ID}:${cdr_deid_base}
...
bq mk --dataset --description "Intermediary dataset to apply cleaning rules on ${cdr_deid_base}" --label "type:staging" --label "release_tag:${dataset_release_tag}" --label "de_identified:true" ${APP_ID}:${cdr_deid_clean_staging}
...
bq update --description "${version} De-identified Clean version of ${cdr_deid_base}" --label "type:deid_clean" --label "release_tag:${dataset_release_tag}" --label "de_identified:true" ${APP_ID}:${cdr_deid_clean}
