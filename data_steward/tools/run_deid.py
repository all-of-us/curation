...
def main(raw_args=None):
    ...
    LOGGER.info(f"Deid has finished.  Successfully executed on tables:  {'\n'.join(successes)}")
    for exc in exceptions:
        LOGGER.error(
            f"Deid encountered exceptions when processing table: {exc}"
