...
bq mk --dataset --description "${version} combined raw version of  ${rdr_dataset} + ${unioned_ehr_dataset}" --label "type:combined_raw" --label "release_tag:${dataset_release_tag}" --label "de_identified:false" ${app_id}:${combined_backup}
...
bq mk --dataset --description "intermediary dataset to apply cleaning rules on ${combined_backup}" --label "type:combined_staging" --label "release_tag:${dataset_release_tag}" --label "de_identified:false" ${app_id}:${combined_staging}
...
bq update --description "${version} combined clean version of ${rdr_dataset} + ${unioned_ehr_dataset}" --set_label "type:combined_clean" --set_label "release_tag:${dataset_release_tag}" --set_label "de_identified:false" ${app_id}:${combined}
...
bq mk --dataset --description "${version} Release version of combined dataset with ${rdr_dataset} + ${unioned_ehr_dataset}" --label "type:combined_clean_release" --label "release_tag:${dataset_release_tag}" --label "de_identified:false" ${app_id}:${combined_release}
