...
virtualenv  -p $(which python2.7) curation_envx

# activate it
source tools/curation_env/bin/activate
...
python tools/run_achilles_and_export.py --bucket=${result_bucket} --folder=${dataset}
