...
def get_destination_ref(client, query_dict):
    """
    ...
    destination_dataset_ref = gbq.DatasetReference(client.project,
...
def generate_job_config(client, query_dict):
    """
    ...
    destination_table = get_destination_ref(client, query_dict)
...
def run_queries(client, query_list, module_info_dict):
    """
    ...
    for index, query_dict in enumerate(query_list):
        try:
            ...
            job_config = generate_job_config(client, query_dict)

            module_name = module_info_dict[cdr_consts.MODULE_NAME]
