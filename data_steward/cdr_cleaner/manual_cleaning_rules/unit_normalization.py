...
def create_unit_standards_table(project_id, dataset_id, table_name):
    fields = [
        {
            "type": "integer",
...
if __name__ == '__main__':
    ...
    create_unit_standards_table(ARGS.project_id, ARGS.dataset_id, UNIT_MAPPING_TABLE)
