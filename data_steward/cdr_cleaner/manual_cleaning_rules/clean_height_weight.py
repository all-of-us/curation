...
WITH
    ...
    -- 1) Drop anything over 16000
    -- 2) For EHR site 705, change anything over 1000 by /35
    phys_df_wt AS (
        SELECT
            person_id,
            measurement_id,
            ...
            CASE
                ...
                WHEN src_id={hpo_id} AND ABS(value_as_number)>1000 THEN value_as_number/35.274
