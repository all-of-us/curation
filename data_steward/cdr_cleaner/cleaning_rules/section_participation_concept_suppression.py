"""
Record suppress (drop the rows) responses related to the section_particiption concept (*_concept_id = 903632)
in both registered and controlled tiers.

Original Issues: DC-1641
"""
...
class SectionParticipationConceptSuppression(
    ...
    def __init__(self, project_id, dataset_id, sandbox_dataset_id):
        ...
        """
        desc = "Drop responses related to the section_participation concept."
        super().__init__(
            issue_numbers=['DC1641'],
            description=desc,
            affected_datasets=[
