...
def parse_domain_mapping_query_cross_domain(project_id, dataset_id, dest_table):
    """
    This function creates a query that generates id mappings in _mapping_domain_alignment
...
def parse_domain_mapping_query_for_same_domains(project_id, dataset_id):
    """
    This function generates a query that generates id mappings in _mapping_domain_alignment for
...
def parse_domain_mapping_query_for_excluded_records(project_id, dataset_id):
    """
    This function generates a query that generates id mappings in _mapping_domain_alignment for the records
...
def get_domain_mapping_queries(project_id, dataset_id):
    """
    This function generates a list of query dicts for creating id mappings in _mapping_domain_alignment.
    The list will get consumed clean_engine

    :param project_id: the project_id in which the query is run
    :param dataset_id: the dataset_id in which the query is run
    :return: a list of query dicts for creating id mappings in _mapping_domain_alignment
    """
...
def get_reroute_domain_queries(project_id, dataset_id, snapshot_dataset_id):
    ...
    :param project_id: the project_id in which the query is run
    :param dataset_id: the dataset_id in which the query is run
    :param snapshot_dataset_id: the copy of dataset_id
