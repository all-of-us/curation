"""
Sandbox and remove any records from a CDR associated with the
concept_ids listed in the csv provided by privacy.

Original Issue: DC-3794
"""
...
ISSUE_NUMBERS = ['dc3794']

PRIVACY_CONCEPTS_PATH = os.path.join( ADDITIONAL_PRIVACY_CONCEPTS_PATH,
    'retroactive_privacy_suppression.csv')


class RetroactivePrivacyConceptSuppression(
        AbstractBqLookupTableConceptSuppression):
...
if __name__ == '__main__':
    ...
    if ARGS.list_queries:
        ...
        query_list = clean_engine.get_query_list(
            ...
            [(RetroactivePrivacyConceptSuppression,)])
