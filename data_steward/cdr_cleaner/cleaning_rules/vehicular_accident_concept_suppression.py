"""
Suppress Vehicular accidents related SNOMED concepts descendants
...
from common import JINJA_ENV, CONDITION_OCCURRENCE
...
SUPPRESSION_RULE_CONCEPT_TABLE = 'vehicular_accident_descendant_concepts'

VEHICULAR_ACCIDENTS_CONCEPT_QUERY = JINJA_ENV.from_string("""
...
WHERE
  ancestor_concept_id IN (4054924,
    141771)
UNION DISTINCT
SELECT
c.*
...
WHERE
  cr.concept_id_2 IN (4054924,
    141771)
  AND REGEXP_CONTAINS(cr.relationship_id, r'(?i)(maps to)|(mapped from)|(is a)')
""")


class VehicularAccidentConceptSuppression(
    ...
    def __init__(
        ...
        """
        desc = "Suppress Vehicular accidents related SNOMED concepts descendants."
    ...
    def create_suppression_lookup_table(self, client):
        concept_suppression_lookup_query = VEHICULAR_ACCIDENTS_CONCEPT_QUERY.render(
