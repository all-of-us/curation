...
def add_module_info_decorator(query_function, project_id, dataset_id,
                              sandbox_dataset_id):
    """
    ...
    # Filter the argument list because some of the cleaning rules don't use all 3 arguments
    argument_list = {
        PROJECT_ID: project_id,
        DATASET_ID: dataset_id,
        SANDBOX_DATASET_ID: sandbox_dataset_id
    ...
    return [
        ...
        for query in query_function(**filtered_argument_list)
    ]
