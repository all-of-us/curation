...
DATA_STAGE_RULES_MAPPING = {
    ...
    DataStage.CONTROLLED_DEID.value: CONTROLLED_TIER_DEID_CLEANING_CLASSES,
    DataStage.CONTROLLED_DEID_BASE.value: CONTROLLED_TIER_DEID_BASE_CLEANING_CLASSES,
    DataStage.CONTROLLED_DEID_CLEAN.value: CONTROLLED_TIER_DEID_CLEAN_CLEANING_CLASSES,
}
