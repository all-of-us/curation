...
then
  ...
  export DRC_BUCKET_NAME=${DRC_BUCKET_NAME}
  export BUCKET_NAME_FAKE=${BUCKET_NAME_FAKE}
  export BUCKET_NAME_NYC=${BUCKET_NAME_NYC}
  export BUCKET_NAME_PITT=${BUCKET_NAME_PITT}
  export BUCKET_NAME_CHS=${BUCKET_NAME_CHS}
  export BIGQUERY_DATASET_ID=${BIGQUERY_DATASET_ID}
  export RDR_DATASET_ID=${RDR_DATASET_ID}
  export EHR_RDR_DATASET_ID=${EHR_RDR_DATASET_ID}
  export UNIONED_DATASET_ID=${UNIONED_DATASET_ID}
  export BUCKET_NAME_UNIONED_EHR=${BUCKET_NAME_UNIONED_EHR}
