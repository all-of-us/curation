...
FITBIT_TABLES = [
    ACTIVITY_SUMMARY, HEART_RATE_MINUTE_LEVEL, HEART_RATE_INTRADAY,
    HEART_RATE_SUMMARY, STEPS_INTRADAY, SLEEP_DAILY_SUMMARY, SLEEP_LEVEL, DEVICE
]
...
SRC_ID_TABLES = [
    ...
    SURVEY_CONDUCT, VISIT_DETAIL, VISIT_OCCURRENCE
]
