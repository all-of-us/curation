...
PARTICIPANT_STATS_CSV = 'participant_stats.csv'
...
DEVICE = 'device'
SLEEP_DAILY_SUMMARY_COUNTS = 'sleep_daily_summary_counts'
SLEEP_DAILY_SUMMARY_30DAYAVG = 'sleep_daily_summary_30dayavg'
SLEEP_DAILY_SUMMARY_EXT = 'sleep_daily_summary_ext'
SLEEP_LEVEL_SHORT = 'sleep_level_short'
...
FITBIT_TABLES = [
    ...
    SLEEP_DAILY_SUMMARY, SLEEP_LEVEL, DEVICE, SLEEP_DAILY_SUMMARY_COUNTS,
    SLEEP_DAILY_SUMMARY_30DAYAVG, SLEEP_DAILY_SUMMARY_EXT, SLEEP_LEVEL_SHORT
]
...
EHR_PROJECT_ID = os.environ.get('EHR_PROJECT_ID')
PDR_PROJECT_ID = os.environ.get('PDR_PROJECT_ID')
