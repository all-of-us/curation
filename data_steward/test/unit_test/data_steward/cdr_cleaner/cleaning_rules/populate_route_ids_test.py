...
class PopulateRouteIdsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cols = (
            ...
            "de.days_supply, de.sig, rm.route_concept_id, de.lot_number, de.provider_id, de.visit_occurrence_id, "
            "de.drug_source_value, de.drug_source_concept_id, de.route_source_value, de.dose_unit_source_value"
        )
