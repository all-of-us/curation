    ...
    def setUp(self):
        ...
        self.completeness = [
            ...
            {'omop_table_name': 'condition_occurrence',
             'table_row_count': 2086163,
             'null_count': 932623,
             'percent_populated': 0.5529481636861548,
             'table_name': 'nyc_cu_condition_occurrence',
            ...
            {'omop_table_name': 'condition_occurrence',
             'table_row_count': 2086163,
             'null_count': 0,
             'percent_populated': 0.8247097662071468,
             'table_name': 'nyc_cu_condition_occurrence',
             'column_name': 'condition_concept_id',
             'concept_zero_count': 365684},
            {'omop_table_name': 'condition_occurrence',
             'table_row_count': 2086163,
             'null_count': 0,
             'percent_populated': 1.0,
            ...
            {'omop_table_name': 'condition_occurrence',
             'table_row_count': 2086163,
             'null_count': 229109,
             'percent_populated': 0.8249331428081124,
             'table_name': 'nyc_cu_condition_occurrence',
             'column_name': 'condition_source_concept_id',
             'concept_zero_count': 136109},
            {'omop_table_name': 'condition_occurrence',
             'table_row_count': 2086163,
             'null_count': 2086163,
             'percent_populated': 0.0,
            ...
            {'omop_table_name': 'condition_occurrence',
             'table_row_count': 2086163,
             'null_count': 663202,
             'percent_populated': 0.6820948315160417,
             'table_name': 'nyc_cu_condition_occurrence',
