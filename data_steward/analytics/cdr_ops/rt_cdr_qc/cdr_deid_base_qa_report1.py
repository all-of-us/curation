...
# + tags=["parameters"]
project_id = ""    # The project to examine (e.g aou-res-curation-prod)
com_cdr = ""       # The comibend dataset (e.g *_combined)
deid_base_cdr = "" # the deid dataset (e.g R*_deid)
pipeline = ""      # the pipeline tables (e.g "pipeline_tables")
