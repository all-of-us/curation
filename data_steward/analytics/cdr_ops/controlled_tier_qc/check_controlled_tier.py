...
# + tags=["parameters"]
project_id: str = "aou-res-curation-prod"  # identifies the project where datasets are located
post_deid_dataset: str = "C2021q2r1_deid"  # the CT deid dataset
pre_deid_dataset: str = "2021q2r1_combined_release"  # the combined dataset
mapping_dataset: str = "C2021q2r1_deid_sandbox"  # the sandbox dataset where mappings are
# -
