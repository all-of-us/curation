...
# # Now let's look at the metrics for particular sites with respect to date/datetime disparity. This will allow us to send the appropriate information.
...
plt.title(f"End Dates Preceding Start Dates: {name_of_interest}", size=15, y = 1.1)
