...
ax.set_title(f"Data After Death for {name_of_interest}", size=14)
...
plt.title(f"Data After Death: {name_of_interest}", size=15, y = 1.1)
...
plt.title(f"{name_of_interest} Data After Death Over Time")
