...
# # Across-Site Statistics for Visit Occurrence ID Failure Rates
#
# ## Failure rates are visit_occurrence_ids that are null, 0, or do not exist in the visit_occurrence table
#
...
fn1 = 'visit_occ_id_failure_rate_table_sheets_analytics_report.xlsx'
file_names = [fn1]
...
ax.set_title("Condition Table Visit ID Failure Rate", size=14)

plt.show()
# plt.savefig("condition_table_visit_id_failure_rate.jpg")
...
ax.set_title("Drug Table Visit ID Failure Rate", size=14)
# plt.savefig("drug_table_visit_id_failure_rate.jpg")
...
ax.set_title("Measurement Table Visit ID Failure Rate", size=14)
# plt.savefig("measurement_table_visit_id_failure_rate.jpg")
...
ax.set_title("Observation Table Visit ID Failure Rate", size=14)
# plt.savefig("observation_table_visit_id_failure_rate.jpg")
...
ax.set_title("Procedure Table Visit ID Failure Rate", size=14)
# plt.savefig("procedure_table_visit_id_failure_rate.jpg")
# -

# # Now let's look at the metrics for particular sites with respect to visit ID failure rates. This will allow us to send them the appropriate information.

fn1_hpo_sheets = 'visit_occ_id_failure_rate_hpo_sheets_analytics_report.xlsx'
...
ax.set_title(f"Visit ID Failure Rates for {name_of_interest}", size=14)

plt.tight_layout()
img_name = name_of_interest + "_visit_id_failure_rate.png"
...
plt.title(f"Visit ID Failure Rates: {name_of_interest}", size=15, y = 1.1)
...
plt.title(f"{name_of_interest} Visit ID Failure Rates Over Time")
...
img_name = name_of_interest + "_visit_id_failure_line_graph.jpg"
