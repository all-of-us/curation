...
ax.set_title(f"Date/Datetime Disparity Rates for {name_of_interest}", size=14)
...
plt.title(f"Date/Datetime Disparity: {name_of_interest}", size=15, y = 1.1)
...
plt.title(f"{name_of_interest} Date/Datetime Disparity Rates Over Time")
