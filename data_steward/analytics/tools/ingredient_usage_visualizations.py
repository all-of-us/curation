...
# +
fig, ax = plt.subplots(figsize=(18, 12))
sns.heatmap(new_table_sheets['ccb'], annot=True, annot_kws={"size": 10},
            fmt='g', linewidths=.5, ax=ax, yticklabels=hpo_id_cols,
            xticklabels=date_cols, cmap="RdYlGn")

ax.set_title("CCB Ingredient Usage", size=14)
plt.savefig("ccb_ingredient_table.jpg")

# +
fig, ax = plt.subplots(figsize=(18, 12))
sns.heatmap(new_table_sheets['diuretics'], annot=True, annot_kws={"size": 10},
            fmt='g', linewidths=.5, ax=ax, yticklabels=hpo_id_cols,
            xticklabels=date_cols, cmap="RdYlGn")

ax.set_title("Diuretic Ingredient Usage", size=14)
plt.savefig("diuretic_ingredient_table.jpg")
...
ax.set_title("MSKNAIDS Ingredient Usage", size=14)
plt.savefig("msknaids_ingredient_table.jpg")
...
ax.set_title("Opioids Ingredient Usage", size=14)
plt.savefig("opioids_ingredient_table.jpg")
...
ax.set_title("Oral Hypoglycemic Ingredient Usage", size=14)
plt.savefig("oralhypo_ingredient_table.jpg")

# +
fig, ax = plt.subplots(figsize=(18, 12))
sns.heatmap(new_table_sheets['painnsaids'], annot=True, annot_kws={"size": 10},
            fmt='g', linewidths=.5, ax=ax, yticklabels=hpo_id_cols,
            xticklabels=date_cols, cmap="RdYlGn")

ax.set_title("Pain NSAIDS Ingredient Usage", size=14)
plt.savefig("pain_nsaids_ingredient_table.jpg")

# +
fig, ax = plt.subplots(figsize=(18, 12))
sns.heatmap(new_table_sheets['statins'], annot=True, annot_kws={"size": 10},
            fmt='g', linewidths=.5, ax=ax, yticklabels=hpo_id_cols,
            xticklabels=date_cols, cmap="RdYlGn")

ax.set_title("Statin Ingredient Usage", size=14)
plt.savefig("statins_ingredient_table.jpg")

# +
fig, ax = plt.subplots(figsize=(18, 12))
sns.heatmap(new_table_sheets['vaccine'], annot=True, annot_kws={"size": 10},
            fmt='g', linewidths=.5, ax=ax, yticklabels=hpo_id_cols,
            xticklabels=date_cols, cmap="RdYlGn")
...
for sheet in hpo_sheets:
    sheet_cols = sheet.columns
    sheet_cols = sheet_cols[start_idx:]  # first col does not have info
    new_df = pd.DataFrame(columns=sheet_cols)
...
ax.set_title("Drug Ingredient Integration Rates for {}".format(name_of_interest), size=14)

plt.tight_layout()
img_name = name_of_interest + "_ingredient_integration.jpg"
