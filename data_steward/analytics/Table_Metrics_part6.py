...
CBCwDiff=(40785788,40785796,40779195,40795733,40795725,40772531,40779190,40785793,40779191,40782561,40789266,3012764,3003214,
3008757)

CMP=(3049187,3053283,40775801,40779224,40779250,40782562,40782579,40785850,40785861,40785869,40789180,40789190,40789527,40791227,3020509,40792413,40792440,40795730,40795740,
40795754)
...
FROM
 ...
 GROUP BY 1
 ORDER BY perc_ancestors DESC, a.src_hpo_id
    '''.format(DATASET, DATASET,DATASET,Physical_Measurement,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
df.shape
