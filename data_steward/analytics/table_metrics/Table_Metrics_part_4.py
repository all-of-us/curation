...
unit_standard_df = pd.io.gbq.read_gbq('''
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET,DATASET, DATASET,measurement_codes,DATASET,DATASET,DATASET,DATASET,measurement_codes,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
antibiotics_standard_df = pd.io.gbq.read_gbq('''
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET, DATASET, DATASET,antibiotics,DATASET,DATASET,DATASET,DATASET,antibiotics,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
ccb_standard_df = pd.io.gbq.read_gbq('''
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET,DATASET,DATASET,ccb,DATASET,DATASET,DATASET,DATASET,ccb,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
INNER JOIN
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET,DATASET, DATASET,diuretics,DATASET,DATASET,DATASET,DATASET,diuretics,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
INNER JOIN
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET, DATASET,DATASET,opioids,DATASET,DATASET,DATASET,DATASET,opioids,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
INNER JOIN
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET,DATASET, DATASET,statins,DATASET,DATASET,DATASET,DATASET,statins,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
INNER JOIN
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET,DATASET, DATASET,msknsaids,DATASET,DATASET,DATASET,DATASET,msknsaids,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
INNER JOIN
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET,DATASET, DATASET,oralhypoglycemics,DATASET,DATASET,DATASET,DATASET,oralhypoglycemics,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
INNER JOIN
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET,DATASET, DATASET,painnsaids,DATASET,DATASET,DATASET,DATASET,painnsaids,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
INNER JOIN
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET,DATASET, DATASET,vaccine,DATASET,DATASET,DATASET,DATASET,vaccine,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
INNER JOIN
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET,DATASET, DATASET,ace_inhibitors,DATASET,DATASET,DATASET,DATASET,ace_inhibitors,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
drugs_standard_df = pd.io.gbq.read_gbq('''
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET,DATASET, DATASET,drugs,DATASET,DATASET,DATASET,DATASET,drugs,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
