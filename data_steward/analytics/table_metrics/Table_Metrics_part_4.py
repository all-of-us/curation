...
unit_standard_df=pd.merge(unit_standard_df,site_df,how='outer',on='src_hpo_id')
...
msknsaids_standard_df = pd.io.gbq.read_gbq('''
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET, DATASET,msknsaids,DATASET,DATASET,DATASET,msknsaids,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
oralhypoglycemics_standard_df = pd.io.gbq.read_gbq('''
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET, DATASET,oralhypoglycemics,DATASET,DATASET,DATASET,oralhypoglycemics,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
ace_inhibitors_standard_df = pd.io.gbq.read_gbq('''
    ...
    ORDER BY
        1 DESC
    '''.format(DATASET, DATASET,ace_inhibitors,DATASET,DATASET,DATASET,ace_inhibitors,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
msknsaids_standard_df=msknsaids_standard_df[["src_hpo_id","route_success_rate"]]
oralhypoglycemics_standard_df=oralhypoglycemics_standard_df[["src_hpo_id","route_success_rate"]]
...
ace_inhibitors_standard_df=ace_inhibitors_standard_df[["src_hpo_id","route_success_rate"]]
...
msknsaids_standard_df=msknsaids_standard_df.rename(columns={"route_success_rate": "msknsaids_success_rate"})
oralhypoglycemics_standard_df=oralhypoglycemics_standard_df.rename(columns={"route_success_rate": "oralhypoglycemics_success_rate"})
...
ace_inhibitors_standard_df=ace_inhibitors_standard_df.rename(columns={"route_success_rate": "ace_inhibitors_success_rate"})
drugs_standard_df=drugs_standard_df.rename(columns={"route_success_rate": "drugs_overall_success_rate"})
liste=[antibiotics_standard_df,ccb_standard_df,diuretics_standard_df,opioids_standard_df,statins_standard_df,msknsaids_standard_df,oralhypoglycemics_standard_df,painnsaids_standard_df
       ,vaccine_standard_df,ace_inhibitors_standard_df]
...
drugs_standard_df=pd.merge(drugs_standard_df,site_df,how='outer',on='src_hpo_id')
...
top_antibiotics_ingredient=(1734104,1836430,1713332,1797513,1705674,1786621,1742253,997881,1707164,1738521,1759842,1746940,902722,45892419,1717327,1777806,1836948,1746114,
1775741)
...
top_msknsaids_ingredient=(1136980,1115008,1177480,1236607,1150345,1395573,1124300,1146810,1185922,1103374,1178663,1118084)
...
msknsaids_ingredient_site = pd.io.gbq.read_gbq('''
    ...
    GROUP BY 1
    ORDER BY count DESC
    '''.format(DATASET, DATASET,DATASET,DATASET,top_msknsaids_ingredient,msknsaids,DATASET,DATASET,DATASET,drugs,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
msknsaids_ingredient_site['success_rate']=round(100*msknsaids_ingredient_site['count']/top_option_size,1)
msknsaids_ingredient_site

msknsaids_ingredient_site=msknsaids_ingredient_site.rename(columns={"success_rate":"msknsaids"})
msknsaids_ingredient_site=msknsaids_ingredient_site[["src_hpo_id","msknsaids"]]
msknsaids_ingredient_site
...
top_oralhypoglycemics_ingredient=(1503297,1525215,1560171,1559684,1580747,19097821,45774751,1515249,19059796,1597756,1516766,1529331,1510202,43009032,40166035,19122137,40239216,43013884)
...
oralhypoglycemics_ingredient_site = pd.io.gbq.read_gbq('''
    ...
    GROUP BY 1
    ORDER BY count DESC
    '''.format(DATASET, DATASET,DATASET,DATASET,top_oralhypoglycemics_ingredient,oralhypoglycemics,DATASET,DATASET,DATASET,drugs,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
oralhypoglycemics_ingredient_site['success_rate']=round(100*oralhypoglycemics_ingredient_site['count']/top_option_size,1)
oralhypoglycemics_ingredient_site

oralhypoglycemics_ingredient_site=oralhypoglycemics_ingredient_site.rename(columns={"success_rate":"oralhypoglycemics"})
oralhypoglycemics_ingredient_site=oralhypoglycemics_ingredient_site[["src_hpo_id","oralhypoglycemics"]]
oralhypoglycemics_ingredient_site
...
top_ace_inhibitors_ingredient=(1308216,1341927,1334456,1340128,1335471,1363749,1310756,1373225,1331235,1342439)
...
ace_inhibitors_ingredient_site = pd.io.gbq.read_gbq('''
    ...
    GROUP BY 1
    ORDER BY count DESC
    '''.format(DATASET, DATASET,DATASET,DATASET,top_ace_inhibitors_ingredient,ace_inhibitors,DATASET,DATASET,DATASET,drugs,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
ace_inhibitors_ingredient_site['success_rate']=round(100*ace_inhibitors_ingredient_site['count']/top_option_size,1)
ace_inhibitors_ingredient_site

ace_inhibitors_ingredient_site=ace_inhibitors_ingredient_site.rename(columns={"success_rate":"ace_inhibitors"})
ace_inhibitors_ingredient_site=ace_inhibitors_ingredient_site[["src_hpo_id","ace_inhibitors"]]
ace_inhibitors_ingredient_site
...
succes_rate=pd.merge(ace_inhibitors_ingredient_site,vaccine_ingredient_site,how='outer',on='src_hpo_id')
succes_rate=pd.merge(succes_rate,painnsaids_ingredient_site,how='outer',on='src_hpo_id')
succes_rate=pd.merge(succes_rate,oralhypoglycemics_ingredient_site,how='outer',on='src_hpo_id')
succes_rate=pd.merge(succes_rate,msknsaids_ingredient_site,how='outer',on='src_hpo_id')
