...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(opioids)),DATASET, DATASET,DATASET,opioids,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
df_opioids.shape
...
sites_drug_success=pd.merge(sites_drug_success,df_opioids,how='outer',on='src_hpo_id')
