...
oralhypoglycemics=(1503297,1560171,1580747,1559684,1525215,1597756,43526465,45774751,40239216,44785829,40166035,1516766,1529331,1502826,1547504,730548)
...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(diuretics)),DATASET, DATASET,DATASET,diuretics,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
df_diuretics.shape
...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(ccb)),DATASET, DATASET,DATASET,ccb,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
df_ccb.shape
...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(vaccine)),DATASET, DATASET,DATASET,vaccine,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
df_vaccine.shape
...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(oralhypoglycemics)),DATASET, DATASET,DATASET,oralhypoglycemics,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(opiods)),DATASET, DATASET,DATASET,opiods,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
df_opiods.shape
...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(antibiotics)),DATASET, DATASET,DATASET,antibiotics,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(statins)),DATASET, DATASET,DATASET,statins,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
df_statins.shape
...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(msknsaids)),DATASET, DATASET,DATASET,msknsaids,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
df_msknsaids.shape
...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(painnsaids)),DATASET, DATASET,DATASET,painnsaids,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
df_painnsaids.shape
...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(ace_inhibitors)),DATASET, DATASET,DATASET,ace_inhibitors,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
...
SELECT
 ...
 ORDER BY 
     ancestor_usage DESC, 
     mde.src_hpo_id
    '''.format(len(set(all_drugs)),DATASET, DATASET,DATASET,all_drugs,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET,DATASET),
                                    dialect='standard'
)
df_all_drugs.shape
...
sites_drug_success[["ace_inhibitors","painnsaids","msknsaids","statins","antibiotics","opiods","oralhypoglycemics","vaccine","ccb","diuretics","all_drugs"]]\
    =sites_drug_success[["ace_inhibitors","painnsaids","msknsaids","statins","antibiotics","opiods","oralhypoglycemics","vaccine","ccb","diuretics","all_drugs"]].astype(int)
sites_drug_success
