...
def create_standard_table(table_name, table_id, drop_existing=False, dataset_id=None, all_nullable=False):
    """
    ...
    :param all_nullable: if True, overrides all fields of the schema to be nullable
    :return: table reference object
    """
