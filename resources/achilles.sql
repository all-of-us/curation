-- Abbreviated queries from https://github.com/OHDSI/Achilles/blob/master/inst/sql/sql_server/Achilles_v5.sql
-- Render comments edited for custom parse
-- Cost-related analyses removed
...
select 0 as analysis_id,  '@source_name' as stratum_1, '1.4.5' as stratum_2, GETDATE() as stratum_3,COUNT_BIG(distinct person_id) as count_value
