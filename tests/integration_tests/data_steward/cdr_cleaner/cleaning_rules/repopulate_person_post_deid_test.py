    ...
    def test_repopulate_person_post_deid(self):
        ...
        tables_and_counts = [{
            ...
            'fields': [
                ...
                'race_concept_id', 'race_source_concept_id','race_source_value', 'ethnicity_concept_id',
            ...
            'cleaned_values': [
                ...
                (5, 0, 1900, 1177221, 903079, 'PMI_PreferNotToAnswer', 903079, 903079, 'PMI_PreferNotToAnswer', "No matching concept", 0,
                )
            ]
        }]
