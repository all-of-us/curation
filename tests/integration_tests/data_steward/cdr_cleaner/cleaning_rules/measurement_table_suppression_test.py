...
class MeasurementTableSuppressionTest(BaseTest.CleaningRulesTestBase):
    ...
    def test_duplicates(self):
        ...
        VALUES
          ...
          (801, 337361, 1585899, '2016-05-01', 45905771, 100, 100, 100, 100, "2020-01-01 05:30:00+00"),
          (802, 337361, 1585899, '2016-05-01', 45905771, 100, 100, 100, 100, "2020-01-01 05:30:00+00"),
          (803, 337361, 1585899, '2016-05-01', 45905771, 100, 100, 100, 100, "2020-01-01 05:30:00+00"),
          (804, 337361, 1585899, '2016-05-01', 45905771, 1000, 100, 100, 100,"2020-01-01 05:30:00+00")
        """),
            self.jinja_env.from_string("""
    ...
    def test_null_and_zero_suppressions(self):
        ...
        (measurement_id, person_id, measurement_concept_id, measurement_date,
         measurement_type_concept_id, value_as_number, value_as_concept_id)
        VALUES
          (801, 337361, 1585899, '2016-05-01', 45905771, 9999999, null),
          (802, 337361, 1585899, '2019-01-01', 45905771, 000, 100),
          (803, 337321, 1585899, '2019-01-01', 45905771, 000, 100),
          (804, 337361, 1585899, '2019-01-01', 45905771, 1, 100),
          (805, 337361, 1585899, '2019-01-01', 45905771, null, null)
        """),
            self.jinja_env.from_string("""
        INSERT INTO `{{project}}.{{dataset}}.measurement_ext`
        (measurement_id, src_id)
