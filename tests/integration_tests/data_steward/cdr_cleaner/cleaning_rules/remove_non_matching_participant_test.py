...
POPULATE_STATEMENTS = {
    ...
    f'_mapping_{OBSERVATION}':
        ...
        VALUES
        (10101, '{{rdr_dataset_id}}', 111, 'ce', 'observation'),
        (10102, '{{ehr_dataset_id}}', 112, '{{hpo_1}}', 'observation'),
        (10201, '{{rdr_dataset_id}}', 121, 'ce', 'observation'),
        (10202, '{{ehr_dataset_id}}', 122, '{{hpo_1}}', 'observation'),
        (10301, '{{rdr_dataset_id}}', 131, 'vibrent', 'observation'),
        (10302, '{{ehr_dataset_id}}', 132, '{{hpo_1}}', 'observation'),
        (10401, '{{rdr_dataset_id}}', 141, 'vibrent', 'observation'),
        (10402, '{{ehr_dataset_id}}', 142, '{{hpo_1}}', 'observation'),
        (20101, '{{rdr_dataset_id}}', 211, 'vibrent', 'observation'),
        (20102, '{{ehr_dataset_id}}', 212, '{{hpo_2}}', 'observation'),
        (20201, '{{rdr_dataset_id}}', 221, 'ce', 'observation'),
        (20202, '{{ehr_dataset_id}}', 222, '{{hpo_2}}', 'observation'),
        (20301, '{{rdr_dataset_id}}', 231, 'ce', 'observation'),
        ...
        (30201, '{{rdr_dataset_id}}', 321, 'vibrent', 'observation'),
        (30202, '{{ehr_dataset_id}}', 322, '{{hpo_3}}', 'observation'),
        (30301, '{{rdr_dataset_id}}', 331, 'vibrent', 'observation'),
        (30302, '{{ehr_dataset_id}}', 332, '{{hpo_3}}', 'observation'),
        (30401, '{{rdr_dataset_id}}', 341, 'ce', 'observation'),
        (30402, '{{ehr_dataset_id}}', 342, '{{hpo_3}}', 'observation'),
        (40101, '{{rdr_dataset_id}}', 411, 'healthpro', 'observation'),
        (40102, '{{ehr_dataset_id}}', 412, '{{hpo_4}}', 'observation'),
        (40201, '{{rdr_dataset_id}}', 421, 'healthpro', 'observation'),
        (40202, '{{ehr_dataset_id}}', 422, '{{hpo_4}}', 'observation'),
        (40301, '{{rdr_dataset_id}}', 431, 'vibrent', 'observation'),
        (40302, '{{ehr_dataset_id}}', 432, '{{hpo_4}}', 'observation'),
        (40401, '{{rdr_dataset_id}}', 441, 'vibrent', 'observation'),
