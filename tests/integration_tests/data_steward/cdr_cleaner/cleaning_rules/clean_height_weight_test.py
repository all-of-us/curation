...
class CleanHeightAndWeightTest(BaseTest.CleaningRulesTestBase):
    ...
    def test_field_cleaning(self):
        ...
        tables_and_counts = [{
            ...
            'fq_sandbox_table_name': [self.fq_sandbox_table_names[0], self.fq_sandbox_table_names[1], self.fq_sandbox_table_names[2], self.fq_sandbox_table_names[3]],
