...
VALUES
    ...
    (101, 1, 40766306, date('2020-01-01'), 45905771, 1585857),
    (102, 1, 1585636, date('2020-01-01'), 45905771, 1585636),
    (103, 1, 1586166, date('2020-01-01'), 45905771, 1586166),
    (104, 1, 1586174, date('2020-01-01'), 45905771, 1586174),
    (105, 1, 1586182, date('2020-01-01'), 45905771, 1586182),
    (106, 1, 1586190, date('2020-01-01'), 45905771, 1586190),
    (107, 1, 40766357, date('2020-01-01'), 45905771, 1586198),
    ...
    (301, 3, 40766306, date('2020-01-01'), 45905771, 1585857),
    (302, 3, 1585636, date('2021-01-01'), 45905771, 1585636),
    (303, 3, 1586166, date('2022-01-01'), 45905771, 1586166)
""")
...
class BackfillLifestyleTest(BaseTest.CleaningRulesTestBase):
    ...
    def test_backfill_lifestyle(self):
        ...
        tables_and_counts = [{
            ...
            'cleaned_values': [
                (101, 1, 40766306, self.date_2020, 45905771, 1585857),
                (102, 1, 1585636, self.date_2020, 45905771, 1585636),
                (103, 1, 1586166, self.date_2020, 45905771, 1586166),
                (104, 1, 1586174, self.date_2020, 45905771, 1586174),
                (105, 1, 1586182, self.date_2020, 45905771, 1586182),
                (106, 1, 1586190, self.date_2020, 45905771, 1586190),
                (107, 1, 40766357, self.date_2020, 45905771, 1586198),
                (201, 2, 9999999, self.date_2020, 99999999, 9999999),
                (301, 3, 40766306, self.date_2020, 45905771, 1585857),
                (302, 3, 1585636, self.date_2021, 45905771, 1585636),
                (303, 3, 1586166, self.date_2022, 45905771, 1586166),
                (304, 3, 1586174, self.date_2022, 45905771, 1586174),
                (305, 3, 1586182, self.date_2022, 45905771, 1586182),
                (306, 3, 1586190, self.date_2022, 45905771, 1586190),
                (307, 3, 40766357, self.date_2022, 45905771, 1586198)
            ]
        }]
