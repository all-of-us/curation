...
class DomainMappingTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_table_mappings_csv_patcher = patch(
            'cdr_cleaner.cleaning_rules.domain_mapping.table_mappings_csv')
        ...
        self.mock_field_mappings_csv_patcher = patch(
            'cdr_cleaner.cleaning_rules.domain_mapping.field_mappings_csv')
        ...
        self.mock_value_mappings_csv_patcher = patch(
            'cdr_cleaner.cleaning_rules.domain_mapping.value_mappings_csv')
    ...
    def test_get_value_mappings(self):
        actual = domain_mapping.get_value_mappings(
            src_table=self.condition_table,
            dest_table=self.procedure_table,
            src_field=self.condition_type_concept_id,
            dest_field=self.procedure_type_concept_id)
        ...
        self.assertDictEqual(actual, {
            self.primary_condition_concept_id: self.primary_procedure_concept_id
        })
