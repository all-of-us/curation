...
from cdr_cleaner.cleaning_rules.fill_source_value_free_text_fields import *


class FillSourceValueFreeTextFieldsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.rule_instance = FillSourceValueFreeTextFields(
    ...
    @mock.patch(
        'cdr_cleaner.cleaning_rules.fill_source_value_free_text_fields.get_full_join_expression'
    )
    @mock.patch(
        'cdr_cleaner.cleaning_rules.fill_source_value_free_text_fields.get_modified_columns'
    )
    @mock.patch(
        'cdr_cleaner.cleaning_rules.fill_source_value_free_text_fields.get_fields_dict'
    )
    @mock.patch(
        'cdr_cleaner.cleaning_rules.fill_source_value_free_text_fields.resources.fields_for'
    )
    @mock.patch(
        'cdr_cleaner.cleaning_rules.fill_source_value_free_text_fields.resources.CDM_TABLES'
    )
    def test_get_query_specs(self, mock_cdm_tables, mock_fields_for,
        ...
        actual = FillSourceValueFreeTextFields(
