...
class HpoReportTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.heel_errors = [{
            ...
            'rule_id':
                2,
            'heel_error':
                'ERROR: 606 - Distribution of age by procedure_concept_id (count = 38); min value should not be negative',
            'record_count':
                38
        }, {
            'analysis_id':
            ...
            'rule_id':
                2,
            'heel_error':
                'ERROR: 406 - Distribution of age by condition_concept_id (count = 36); min value should not be negative',
            'record_count':
                36
        }, {
            'analysis_id':
            ...
            'rule_id':
                2,
            'heel_error':
                'ERROR: 706 - Distribution of age by drug_concept_id (count = 32); min value should not be negative',
            'record_count':
                32
        }, {
            'analysis_id':
            ...
            'rule_id':
                1,
            'heel_error':
                'ERROR: 713-Number of drug exposure records with invalid visit_id; count (n=32) should not be > 0',
            'record_count':
                32
        }, {
            'analysis_id':
            ...
            'rule_id':
                1,
            'heel_error':
                'ERROR: 209-Number of visit records with end date < start date; count (n=28) should not be > 0',
            'record_count':
                28
        }, {
            'analysis_id':
            ...
            'rule_id':
                1,
            'heel_error':
                'ERROR: 613-Number of procedure occurrence records with invalid visit_id; count (n=27) should not be > 0',
            'record_count':
                27
        }, {
            'analysis_id':
            ...
            'rule_id':
                5,
            'heel_error':
                'ERROR: 705-Number of drug exposure records, by drug_concept_id by drug_type_concept_id; 27 concepts in data are not in vocabulary',
            'record_count':
                27
        }, {
            'analysis_id':
            ...
            'rule_id':
                1,
            'heel_error':
                'ERROR: 411-Number of condition occurrence records with end date < start date; count (n=24) should not be > 0',
            'record_count':
                24
        }, {
            'analysis_id':
            ...
            'rule_id':
                1,
            'heel_error':
                'ERROR: 413-Number of condition occurrence records with invalid visit_id; count (n=22) should not be > 0',
            'record_count':
                22
        }, {
            'analysis_id':
            ...
            'rule_id':
                1,
            'heel_error':
                'ERROR: 711-Number of drug exposure records with end date < start date; count (n=18) should not be > 0',
            'record_count':
                18
        }, {
            'analysis_id':
            ...
            'rule_id':
                2,
            'heel_error':
                'ERROR: 206 - Distribution of age by visit_concept_id (count = 13); min value should not be negative',
            'record_count':
                13
        }, {
            'analysis_id':
            ...
            'rule_id':
                14,
            'heel_error':
                'ERROR: 600-Number of persons with at least one procedure occurrence, by procedure_concept_id; 8 concepts in data are not in correct vocabulary',
            'record_count':
                8
        }, {
            'analysis_id':
            ...
            'rule_id':
                10,
            'heel_error':
                'ERROR: 202-Number of persons by visit occurrence start month, by visit_concept_id; 7 concepts in data are not in correct vocabulary',
            'record_count':
                7
        }, {
            'analysis_id':
            ...
            'rule_id':
                12,
            'heel_error':
                'ERROR: 400-Number of persons with at least one condition occurrence, by condition_concept_id; 7 concepts in data are not in correct vocabulary',
            'record_count':
                7
        }, {
            'analysis_id':
            ...
            'rule_id':
                8,
            'heel_error':
                'ERROR: 4-Number of persons by race; 5 concepts in data are not in correct vocabulary',
            'record_count':
                5
        }, {
            'analysis_id':
            ...
            'rule_id':
                9,
            'heel_error':
                'ERROR: 5-Number of persons by ethnicity; 5 concepts in data are not in correct vocabulary (CMS Ethnicity)',
            'record_count':
                5
        }, {
            'analysis_id':
            ...
            'rule_id':
                7,
            'heel_error':
                'ERROR: 2-Number of persons by gender; 2 concepts in data are not in correct vocabulary',
            'record_count':
                2
        }]
        self.results = [{
    ...
    def assert_report_data_in_output(self, report_data, render_output):
        ...
        self.assertTrue(
            report_data[consts.HPO_NAME_REPORT_KEY] in render_output)
        self.assertTrue(report_data[consts.FOLDER_REPORT_KEY] in render_output)
        self.assertTrue(
            report_data[consts.TIMESTAMP_REPORT_KEY] in render_output)
        for (file_name, found, parsed,
             loaded) in report_data.get(consts.RESULTS_REPORT_KEY, []):
